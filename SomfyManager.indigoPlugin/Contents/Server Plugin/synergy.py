#########
#
# Stolen from https://github.com/bendews/somfy-mylink-synergy/blob/master/somfy_mylink_synergy/__init__.py
# to give me a list of commands I can implement
#
# This file is not used by the plugin in any way.
#
#########
